function printBar(barcode){

	var span_Text = document.getElementById(barcode).innerText;
	alert("hai"+span_Text);
	$("#barcode").JsBarcode(span_Text,{format:"CODE128",displayValue:true,fontSize:20});
	/*alert("bye");*/
}
