(function(angular) {
    ...
    angular.module('gridster', [])
        ...
        .constant('gridsterConfig', {
            ...
            rowHeight: '/3', // height of grid rows. 'match' will make it the same as the column width, a numeric value will be interpreted as pixels, '/2' is half the column width, '*5' is five times the column width, etc.
            ...
            function($document, $timeout, $window) {
                function GridsterDraggable($el, scope, gridster, item, itemOptions) {
                    ...
                    function setClosable(){
                        $el.find('.removeField').click(function(){
